...
WALZING_BARAGE_TIMER = "120000"
TARGET_WINDOW_HEIGHT = "2048"
TARGET_WINDOW_WIDTH = "2048"
FIRESOLUTION_PATH_EXMPL = "{}/firebases/firesolution-{{}}.{{}}".format(HOME)
#MUNITIONS_DEPOT = "{}/firebases/firefox/firefox".format(HOME)
MUNITIONS_DEPOT = "/usr/bin/firefox"
GUN_PLACEMENT = "{}/firebases/selenese-runner.jar".format(HOME)
ACTION_LOG_FOLDER = "/{}/firebases/".format(HOME)
